...
for lam0 in lam0s:
    for lg in lam_gammas:
        ...
        if run_exp:
            ...
            y0_list = np.load('Experiment5Results/y0_list.npy')
            ...
            np.save(f"Experiment5Results/Exp5_gamma{gamma:.8f}_lam{lam0:.8f}.npy",ys_sim)
